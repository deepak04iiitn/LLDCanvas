...
export default async function BlogDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const jsonLd = {
    ...
    headline: blog.title,
    description: blog.excerpt,
    author: { '@type': 'Organization', name: blog.author?.name ?? 'LLDCanvas Team', url: 'https://www.lldcanvas.in' },
    publisher: { '@type': 'Organization', name: 'LLDCanvas', url: 'https://www.lldcanvas.in' },
    datePublished: blog.publishedAt,
    dateModified: blog.updatedAt,
    url: `https://www.lldcanvas.in/blog/${blog.slug}`,
    ...
    <>
      ...
      <JsonLd data={{
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://www.lldcanvas.in/blog' },
          { '@type': 'ListItem', position: 3, name: blog.title, item: `https://www.lldcanvas.in/blog/${blog.slug}` },
        ],
      }} />
